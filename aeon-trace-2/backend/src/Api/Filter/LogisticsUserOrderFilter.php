...
class LogisticsUserOrderFilter extends AbstractFilter
{
    /**
     * @param mixed $value
     */
    protected function filterProperty(
        ...
        if ($property !== 'order' || !is_array($value) || !isset($value['userData']) || $resourceClass !== Logistics::class) {
            return;
        }
    ...
    public function getDescription(string $resourceClass): array
    {
        ...
        return array_map(function ($strategy) {
            return [
                ...
                'required' => false,
                'description' => 'Sort logistics by the user who created them (last name, first name).',
                'schema' => [
                    'type' => 'string',
                    'enum' => ['asc', 'desc'],
                ],

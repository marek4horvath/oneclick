...
final class Version20250408132325 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create merged dpp listing view (Dpp and ProductStep).';
    }
    ...
    {
        $this->addSql('DROP VIEW dpp_listing_view');
    }
}
